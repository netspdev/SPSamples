...
namespace QuillCorporation.VSPackage
{
    ...
    //     - An empty bugsy file in the same directory as NewFileItems.vsdir. In
    //       our case we chose Bugsy.bugsy. Note this file name appears in Editor.vsdir
    ...
    //          - "Bugsy" - This is the base file name. New files will initially
    //             be named as Bugsy1.bugsy, Bugsy2.bugsy... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    Bugsy.bugsy|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - Bugsy.bugsy - our empty bugsy file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".bugsy";
        ...
        #region Fields
        private VSPackagePackage myPackage;
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the bugsy document 
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidVSPackageCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidVSPackageCmdSet, PkgCmdIDList.IDMX_RTF);
